...
namespace Necrofancy.PrepareProcedurally.Editor
{
  ...
  /// <remarks>
  /// Generated by:
  /// - Copying a decompilation of PawnTable
  /// - Removing any references or usages of LookTarget.
  /// Any changes to the Rimworld PawnTable class will likely necessitate repeating this process for consistency.
  /// </remarks>
